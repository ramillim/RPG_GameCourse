...
namespace UnityEngine.PostProcessing
{
    ...
    public class EyeAdaptationModel : PostProcessingModel
    {
        ...
        public struct Settings
        {
            ...
            [IsMin(0f), Tooltip("Exposure bias. Use this to offset the global exposure of the scene.")]
            ...
            [IsMin(0f), Tooltip("Adaptation speed from a dark to a light environment.")]
            public float speedUp;

            [IsMin(0f), Tooltip("Adaptation speed from a light to a dark environment.")]
